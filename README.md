...
- 🎮 **bat-bet:** A platform where users can follow the latest CS2 tournaments and make predictions on match outcomes. The more accurate your predictions, the higher your rank on bat-bet! Key features include:  
  ...
  - **User Profiles:** Personalized profiles where users can track their predictions, rankings, and progress.  
  - **Social Interaction:** Users can follow others, share predictions, and engage in community-driven content.
